...
func (a *ClubsApiService) GetClubActivitiesById(ctx context.Context, id int32, localVarOptionals *ClubsApiGetClubActivitiesByIdOpts) ([]SummaryActivity, *http.Response, error) {
	var (
...
func (a *ClubsApiService) GetClubAdminsById(ctx context.Context, id int32, localVarOptionals *ClubsApiGetClubAdminsByIdOpts) ([]SummaryAthlete, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ClubsApiService) GetClubMembersById(ctx context.Context, id int32, localVarOptionals *ClubsApiGetClubMembersByIdOpts) ([]SummaryAthlete, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
